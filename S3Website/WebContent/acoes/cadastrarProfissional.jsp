...
<%
  ...
  String[] enderecoInfo =
      new String[] {"cep", "cidade", "bairro", "rua", "numero", "complemento", "uf"};
  String[] enderecoInfoComplemento = new String[] {"Resi", "Come"};

  String[] endInfos = new String[] {"Cep", "Cidade", "Bairro", "Rua", "Numero", "Complemento", "Estado"};
  ...
  for (int enderecoInfoIndex = 0; enderecoInfoIndex < 2; enderecoInfoIndex++) {
    ...
    for (int infoIndex = 0; infoIndex < enderecoInfo.length; infoIndex++) {
      ...
      String parameter =
          enderecoInfo[infoIndex] + enderecoInfoComplemento[enderecoInfoIndex];
  ...
  celular.setInfo(TelefoneInfo.Tipo, telefone.CELULAR);
  celular.setInfo(TelefoneInfo.Numero, request.getParameter("celular"));
